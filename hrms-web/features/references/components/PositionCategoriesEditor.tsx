...
import type { Organization, PositionCategory } from "../types";
import { useReferenceList } from "../hooks/useReferenceList";
import { InlineNameCell } from "./InlineNameCell";

export function PositionCategoriesEditor() {
  ...
  const {
    ...
    deleteSelected,
    crudRef,
  } = useReferenceList<PositionCategory>({
    table: "position_categories",
    getSelectAllList: (sorted) =>
      organizationFilterId
        ? sorted.filter((r) => r.organization_id === organizationFilterId)
        : sorted,
  });
  ...
  const filteredList = organizationFilterId
    ? sortedList.filter((r) => r.organization_id === organizationFilterId)
    : sortedList;
    ...
    <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead>
              ...
              >
                Наименование категории {sortDir === "asc" ? "↑" : "↓"}
              </button>
            </TableHead>
            ...
            <TableRow key={row.id}>
              ...
              <TableCell className="p-0">
                <InlineNameCell
                  ...
                  ariaLabel="Наименование категории"
                />
              </TableCell>
      ...
      {filteredList.length === 0 && (
        <p className="text-center text-sm text-muted-foreground">
          {list.length === 0
            ? "Нет записей. Нажмите «Добавить», чтобы создать категорию должности."
            : "Нет записей по выбранной организации."}
        </p>
      )}
      ...
      <Dialog open={addOpen} onOpenChange={setAddOpen}>
        <DialogContent className="sm:max-w-md" showCloseButton>
          <DialogHeader>
            <DialogTitle>Добавить категорию должности</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-2">
            <div className="space-y-1">
              ...
              <Input
                ...
                placeholder="Руководители, Специалисты, Служащие, Рабочие"
